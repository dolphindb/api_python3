...
class TestBasicDataTypes(unittest.TestCase):
    ...
    def test_date_vector(self):
        ...
        expected = [np.datetime64('2012-10-02', dtype='datetime64[D]'),
                    np.datetime64('2012-10-03', dtype='datetime64[D]'),
                    np.datetime64('2012-10-04', dtype='datetime64[D]')]
        self.assertEqual((re == expected).all(), True)

    def test_datetime_vector(self):
        re = self.s.run("2012.10.01T15:00:04 + 2009..2011")
        expected = [np.datetime64('2012-10-01T15:33:33', dtype='datetime64[s]'),
                    np.datetime64('2012-10-01T15:33:34', dtype='datetime64[s]'),
                    np.datetime64('2012-10-01T15:33:35', dtype='datetime64[s]')]
        self.assertEqual((re == expected).all(), True)
