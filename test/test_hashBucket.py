...
class TestFunctionHashBucket(unittest.TestCase):
    ...
    def test_hashBucket_input_date(self):
        re = self.s.hashBucket(np.array(pd.date_range(start='1/1/2012', end='12/31/2012'), dtype='datetime64[D]'), 50)
    ...
    def test_hashBucket_input_month(self):
        ...
        # assert_array_equal(re, expected)
        re = self.s.hashBucket(np.datetime64('2012-06', dtype='datetime64[M]'), 5)
    ...
    def test_hashBucket_input_second(self):
        ...
        # assert_array_equal(re, expected)
        re = self.s.hashBucket(np.datetime64('2002-12-02T00:25:36', dtype='datetime64[s]'), 3)
    ...
    def test_hashBucket_input_millisecond(self):
        ...
        # assert_array_equal(re, expected)
        re = self.s.hashBucket(np.datetime64('2002-12-01T00:25:36.009', dtype='datetime64[ms]'), 7)
    ...
    def test_hashBucket_input_nanosecond(self):
        ...
        # assert_array_equal(re, expected)
        re = self.s.hashBucket(np.datetime64('2002-12-01T00:25:36.009485695', dtype='datetime64[ns]'), 7)
