...
| 写入批量数据，且数据结构可以较为便捷地转换为 pandas.DataFrame | TableAppender</br>TableUpserter</br>PartitionedTableAppender | 自动类型转换，不需要关心类型对应的问题，具体使用请参考本文 2.4|
...
## 2. TableAppender, TableUpserter 与 PartitionedTableAppender
...
### 2.4 TableAppender, TableUpserter 与 PartitionedTableAppender 的对比
